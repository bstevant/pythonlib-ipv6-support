...
from: https://github.com/gevent/gevent/tree/master/examples
"""
...
if __name__ == '__main__':
    ...
    # IPv4-only 
    #server = StreamServer(('localhost', 16000), echo)
    #server = StreamServer(('', 16000), echo)
    # IPv6 !
    #server = StreamServer(('::', 16000), echo)
    server = StreamServer((None, 16000), echo)
